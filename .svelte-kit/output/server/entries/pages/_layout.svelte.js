import { E as sanitize_props, F as rest_props, A as push, G as fallback, I as spread_attributes, J as clsx, K as slot, M as bind_props, D as pop, N as copy_payload, O as assign_payload, P as escape_html, Q as ensure_array_like, R as attr_class, S as store_get, T as attr, U as stringify, V as unsubscribe_stores } from "../../chunks/index.js";
import "../../chunks/client.js";
import { l as loginOpen, s as session, a as supabase, b as authView } from "../../chunks/AuthView.js";
...
function EmailAuth($$payload, $$props) {
  push();
  let authView2 = fallback($$props["authView"], "sign_in");
  ...
  let loading = false;
  let lngKey = authView2 === "sign_in" ? "sign_in" : "sign_up";
  let $$settled = true;
  let $$inner_payload;
      ...
      children: ($$payload3) => {
        Container($$payload3, {
          ...
          children: ($$payload4) => {
            ...
            Input($$payload4, {
              ...
              autocomplete: authView2 === VIEWS.SIGN_IN ? "current-password" : "new-password",
              appearance,
              get value() {
                return password;
              },
        ...
        if (showLinks) {
          ...
          Container($$payload3, {
            ...
            appearance,
            children: ($$payload4) => {
              if (authView2 === VIEWS.SIGN_IN && magicLink) {
                $$payload4.out += "<!--[-->";
                Anchor($$payload4, {
...
function Auth($$payload, $$props) {
  ...
  let $$inner_payload;
  function $$render_inner($$payload2) {
    $$payload2.out += `<div${attr_class(clsx(theme !== "default" ? themeVariables : ""))}>`;
    if (SignView) {
      $$payload2.out += "<!--[-->";
      SocialAuth($$payload2, {
        appearance,
...
function _layout($$payload, $$props) {
  ...
  $$payload.out += `<nav class="fixed bg-base-100 justify-between top-0 left-0 right-0 z-60"><div class="navbar max-w-3xl mx-auto justify-between"><div><button class="btn btn-ghost text-xl">PokePage</button></div> <div>`;
  if (store_get($$store_subs ??= {}, "$session", session)) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<button class="btn btn-ghost">Logout</button> <a${attr("href", `/${stringify(store_get($$store_subs ??= {}, "$session", session).user.email)}`)}><span class="btn btn-ghost">${escape_html(store_get($$store_subs ??= {}, "$session", session).user.email)}</span></a>`;
  } else {
    $$payload.out += "<!--[!-->";
    $$payload.out += `<button class="btn btn-ghost">Login</button>`;
  }
  $$payload.out += `<!--]--></div></div></nav> `;
  if (store_get($$store_subs ??= {}, "$loginOpen", loginOpen)) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<div class="fixed inset-0 z-20 flex items-center justify-center bg-base-300 bg-opacity-80"><div class="card bg-base-100 p-8 shadow-lg z-20">`;
    Auth($$payload, {
      supabaseClient: supabase,
      view: store_get($$store_subs ??= {}, "$authView", authView),
      appearance: {
        theme: ThemeSupa,
